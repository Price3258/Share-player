...
<% String email= (String)session.getAttribute("email");
   ...
   int receive_user = dao.getuser_idn(nickname);
%>
...
.MainMenu {
  ...
  <body>
    <div class="leftMenu">
      <table class="table">
		<thead>
			<tr><td><%=dao.getNickname(user_id) %>님의 쪽지함</td></tr>
		</thead>
		<tbody>
    ...
    <div class="Mainmenu">
      ...
      <form name=writeform method=post action="sendOk.jsp?send_id=<%=user_id%>">
          <table class="table">
              ...
              <tr>
                  <td>보낸사람</td>
                  <td><input class="form-control" type="text" name="receive_id" readonly="readonly" value="<%=nickname%>"/> </td>
              </tr>
              <tr>
                  <td>제목</td>
